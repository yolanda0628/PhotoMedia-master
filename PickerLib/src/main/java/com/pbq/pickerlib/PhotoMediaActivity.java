...
import com.pbq.pickerlib.util.ImageFolderPopWindow;
...
public class PhotoMediaActivity extends AppCompatActivity{
    ...
    private void loadImages(final PhotoVideoDir imageDir) {
        PhotoMediaAdapter adapter = new PhotoMediaAdapter(PhotoMediaActivity.this, imageDir);
